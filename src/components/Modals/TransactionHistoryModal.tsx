...
export const TransactionHistoryModal: React.FC<TransactionHistoryModalProps> = ({
  ...
  return (
    <div
      ...
      className="fixed inset-0 bg-slate-950/50 backdrop-blur-sm z-[65] flex items-end sm:items-center justify-center p-0 sm:p-4 transition-all duration-300"
    >
      <div
        onClick={(e) => e.stopPropagation()}
        className="glass-card rounded-t-[2rem] sm:rounded-3xl p-5 md:p-8 w-full max-w-2xl shadow-2xl space-y-5 max-h-[88vh] overflow-y-auto border border-white/10"
      >
